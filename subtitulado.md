---
layout: main3
permalink: /subtitulado
title: "Peliculas/Series en Subtitulado"
---


<main class="home" id="post" role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Blog">
     <div cold-md="12" align="center">
        <h2 class="top_h3"> Peliculas / Series Subtitulados </h2>
    </div>
    <div id="grid" class="row flex-grid">
            {% assign post_news = site.posts  | where:"idioma","Subtitulado"%}
